...
import 'gradient_container_view.dart';
    ...
    return Consumer<ForecastViewModel>(
        builder: (context, weatherViewModel, child) => Container(
            ...
            child: RefreshIndicator(
                ...
                onRefresh: (){
                  if(weatherViewModel.city!=null){
                    return refreshWeather(weatherViewModel, context);
                  }else{
                    return null;
                  }
                },
                child: ListView(
                  children: <Widget>[
                    ...
                    weatherViewModel.isRequestPending
                        ? buildBusyIndicator()
                        : weatherViewModel.city==null?Center(
                        child: Text('Insert a city to start!',
                            style: TextStyle(
                    ...
                    :weatherViewModel.isRequestError
                            ...
                            : Column(children: [
                                LocationView(
                                  ...
                                  city: weatherViewModel.city.toUpperCase(),
                                ),
                                SizedBox(height: 50),
                                WeatherSummary(
                                ...
                                SizedBox(height: 20),
                                (weatherViewModel.description == null)
                                    ? Container()
                                    : WeatherDescriptionView(
                                        weatherDescription:
                                            weatherViewModel.description.toUpperCase()),
                                SizedBox(height: 140),
                      Text('5 Days Forecast',
                          style: TextStyle(
                            ...
                            color: Colors.white,
                                ...
                                (weatherViewModel.lastUpdated == null)
                                    ? Container()
                                    : LastUpdatedView(
                                        lastUpdatedOn:
